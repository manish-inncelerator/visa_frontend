...
<nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top d-none d-lg-block">
    <div class="container-fluid">
        ...
        <div class="d-flex ">
            <a href="auth/register" class="btn btn-blue me-2">
                <i class="bi bi-whatsapp"></i> Chat
            </a>
            <a href="auth/signup" class="btn btn-success me-2">
                <i class="bi bi-person-plus"></i> Sign Up
            </a>
            <a href="auth/login" class="btn btn-light border">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <div class="d-flex flex-column mt-auto">
                    <a href="auth/register" class="btn btn-blue mb-2">
                        <i class="bi bi-whatsapp"></i> Chat
                    </a>
                    <a href="auth/signup" class="btn btn-success mb-2">
                        <i class="bi bi-person-plus"></i> Sign Up
                    </a>
                    <a href="auth/login" class="btn btn-light border">
                        <i class="bi bi-box-arrow-in-right"></i> Log in
