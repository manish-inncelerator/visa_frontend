...
$photo = $database->get("photos", "photo_filename", ["traveler_id" => $traveler_id, "order_id" => $orderId]);

if ($photo) {
    $photoPath = realpath("../../user_uploads/{$orderId}/{$name}/{$photo}");
...
$database->delete("photos", ["traveler_id" => $traveler_id]);
